import {addTodo, findById, toggleTodo, toggleById, updateTodo, removeTodo, filterTodos} from './todoHelpers'
...
test('filterTodos should return only completed items for the complete route', () => {
  ...
  const result = filterTodos('complete', startTodos)
...
test('filterTodos should return only incompleted items for the active route', () => {
  ...
  const result = filterTodos('active', startTodos)
